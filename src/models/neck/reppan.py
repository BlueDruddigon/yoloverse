...
from src.layers.common import BepC3, BottleRep, ConvBNReLU, RepBlock, RepVGGBlock, Transpose
...
class CSPRepPANNeck(nn.Module):
    ...
    def __init__(
      ...
      channels_list: Optional[Sequence[int]] = None,
      num_repeats: Optional[Sequence[int]] = None,
      block: Callable[..., nn.Module] = BottleRep,
      csp_ratio: float = 1. / 2,
      stage_block_type: str = 'BepC3'
    ) -> None:
        """Initializes the CSPRepPANNeck module.

        :param channels_list: list of channel sizes for each stage of the neck. default: None
        :param num_repeats: list of number of repetitions for each stage of the neck. default: None
        :param block: block to use in the neck. default: BottleRep
        :param csp_ratio: hidden ratio for BepC3 block. default: 0.5
        :param stage_block_type: block to use in each stage of the neck. default: BepC3
        """
        super().__init__()
